...
class B:public A
{
    ...
    public:
        ...
        void getdata()
        {
            ...
            cin>>c;     //this will not genrate erorr because it will become public member of B
            cin>>x;
            cin>>y;
            cin>>z;
        }
        ...
        void putdata()
        {
           // cout<<"a:"<<a<<endl; It Will Generate erorr  because it is private data member of base class A and it is not inherited
            ...
            cout<<"c:"<<c<<endl;    //this will not genrate erorr because it will become public member of B
            cout<<"x:"<<x<<endl;
            cout<<"y:"<<y<<endl;
            cout<<"z:"<<z<<endl;
        }
...
{   
    ...
    //o.b=20; This will generate erorr because it will be the protected member of B because it will inherited from A As pubilc
    o.c=30;     // This will generate erorr because it will be the public member of B because it will inherited from A As puplic
